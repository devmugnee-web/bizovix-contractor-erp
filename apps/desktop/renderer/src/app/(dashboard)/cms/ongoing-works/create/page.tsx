...
import { useAllOrganizations, useCreateCmsWork } from "@bizovix/api-client";
...
export default function CreateOngoingWorkPage() {
  ...
  const { register, control, handleSubmit, formState: { errors } } = useForm<CreateCmsWorkFormValues>({
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader title="Add Manual Work" subtitle="Add a project that did not originate from the tender workflow" />
