...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    icon: BarChart3,
    children: [
      { label: "Document Purchase Report", href: "/reports/tenders/document-purchase", icon: FileText },
      ...
      { label: "Project-wise Profit/Loss", href: "/reports/projects/profit-loss", icon: TrendingUp },
      { label: "General Profit/Loss Statement", href: "/reports/financial/profit-loss", icon: LineChart },
