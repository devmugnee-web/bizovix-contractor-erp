...
export const REPORT_CATEGORIES: ReportCategoryDef[] = [
  ...
  },
  {
    ...
    reports: [
      ...
      r("completion-certificates", "Completion Certificate Register", "Project completion certificate lifecycle."),
      r("final-bills", "Final Bill Register", "Certified final bills and collection status."),
      r("dlp-register", "DLP Register", "Defects liability periods and extensions."),
      r("open-defects", "Open Defect Register", "Unresolved project defects and rectification due dates."),
      r("retention-releases", "Retention Release Register", "Partial and full retention release history."),
      r("pg-bg-releases", "PG/BG Release Register", "Guarantee release and return lifecycle."),
      r("handovers", "Handover Register", "Provisional and final handover status."),
      r("closeout-status", "Project Closeout Status", "Backend-generated closeout status by project."),
      r("final-profitability", "Final Project Profitability", "Certified revenue, actual cost and accrued profitability."),
