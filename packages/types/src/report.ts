...
export interface ReportOptions{organizations:Array<{id:string;shortName:string}>;works:Array<{id:string;workName:string}>;accounts:Array<{id:string;accountName:string}>;categories:string[]}
